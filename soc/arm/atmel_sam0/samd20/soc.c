...
{
#ifdef DT_ATMEL_SAM0_CLOCK_XOSC_CLOCK_FREQUENCY
...
#if DT_ATMEL_SAM0_CLOCK_XOSC32K_CLOCK_FREQUENCY && \
		DT_ATMEL_SAM0_CLOCK_GCLK1_CLOCK_FREQUENCY == \
		DT_ATMEL_SAM0_CLOCK_XOSC32K_CLOCK_FREQUENCY
	/* Route XOSC32K to GCLK1 */
	GCLK->GENCTRL.reg =
	    GCLK_GENCTRL_ID(1) | GCLK_GENCTRL_SRC_XOSC32K | GCLK_GENCTRL_GENEN;
#elif DT_ATMEL_SAM0_CLOCK_OSC8M_CLOCK_FREQUENCY && \
		DT_ATMEL_SAM0_CLOCK_GCLK1_CLOCK_FREQUENCY == \
		DT_ATMEL_SAM0_CLOCK_OSC8M_CLOCK_FREQUENCY
...
#error Unsupported main clock source.
	...
	u32_t mul = (DT_ATMEL_SAM0_CLOCK_GCLK0_CLOCK_FREQUENCY +
			DT_ATMEL_SAM0_CLOCK_GCLK1_CLOCK_FREQUENCY / 2) /
			DT_ATMEL_SAM0_CLOCK_GCLK1_CLOCK_FREQUENCY;
